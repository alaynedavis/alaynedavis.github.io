...
function openMenu() {
    ...
    menuOpen = true;
    document.querySelectorAll('.menu-item').forEach((item) => item.classList.add('menu-dropdown'));
}
function closeMenu() {
    open.style.display = 'block';
    close.style.display = 'none';
    menuOpen = false;
    document.querySelectorAll('.menu-item').forEach((item) => item.classList.remove('menu-dropdown'));
}
